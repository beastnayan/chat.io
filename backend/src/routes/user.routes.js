...
import { registerUser , loginUser ,checkPhoneNumber , checkUserName} from "../controllers/auth.controllers.js";
...
router.route("/check-phone/:phonenumber").get(checkPhoneNumber);
